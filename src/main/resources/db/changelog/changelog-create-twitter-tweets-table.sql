...
--changeset VitaliyTaranenko:create-twitter-tweets-table
--commentcreate table twitter.tweets
...
--changeset VitaliyTaranenko:add-twitter-user_profiles-table-column-modified_timestamp
